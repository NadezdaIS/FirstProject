...
public class StringExtendedAssignment {
    public static void main(String[] args) {

//Task
        // Write a program that returns true interactively, if a user enters a string containing
...
//Task
        //Write a program that accepts a String from a user and prints an interactive
        //response telling the user if the word is the same when spelt backwards.
...
//Task
        // Write a program that accepts any of the primary colors as a String and returns
        // the complimentary color of that color to the user.
